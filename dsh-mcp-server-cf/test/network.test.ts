...
function srv(id: string, over: Partial<DBServer> = {}): DBServer {
  return {
    ...
    load_updated_at: null, gpu_sharing_mode: 'shared', connection_type: 'standard', python_version: null, torch_version: null, cuda_version: null, top_cpu_tasks: null, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z',
    ...over,
  };
}
